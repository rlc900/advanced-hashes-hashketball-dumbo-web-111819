...
def num_points_scored(players_name)
  #return number of points of player passed in 
...
def winning_team 
  ...
  game_hash.each do |location, team|
    ...
    team[:players].each do |player|
     ...
     champions, total_p = name_of_team, team_points if team_points > total_p
  end 
  return champions
end 
...
def long_name_steals_a_ton?
  ...
  game_hash.each do |location, team|
    team[:players].each do |players|
      steals, most_steals = player[:player_name], player[:steals] if player[:steals] > most_steals 
    end 
  end 
